                                ...
                                <div class="header-upper-nav">
                                    <ul class="nav">
                                        ...
                                        <li>
                                            ...
                                            <a href="#" style="font-weight: 600;"> <ion-icon name="person-outline"></ion-icon>  <?php echo $_SESSION['username']?> </a>
                                            <ul class="subnav">
                                                <li><a href=""><ion-icon name="wallet-outline"></ion-icon> Tài khoản: <?php echo  $_SESSION['balance']?> đ</a></li>
